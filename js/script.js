...
let weatherAPIKey = 'f3a506ef9967328b5f13293bce20e0f6';
...
let init = () => {
    weatherForCity('Jovellanos').then(() => document.body.style.filter = 'blur(0)');
}
init();
...
let dayOfWeek = (dt = new Date().getTime()) => {
    return new Date(dt).toLocaleDateString('es-ES', {'weekday': 'long'});
}